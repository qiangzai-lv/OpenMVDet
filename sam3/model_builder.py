...
from sam3.device_utils import get_device_type, get_default_device, is_accelerator_available, setup_tf32, safe_compile
...
def build_sam3_image_model(
    ...
    Args:
        ...
        device: Device to load the model on ('cuda', 'npu', 'mlu' or 'cpu')
    ...
    if enable_inst_interactivity:
        sam3_pvs_base = build_tracker(apply_temporal_disambiguation=False,use_decoupled_selection=False)
...
def build_sam3_video_model(
    ...
    tracker = build_tracker(apply_temporal_disambiguation=apply_temporal_disambiguation, use_decoupled_selection=use_decoupled_selection)
