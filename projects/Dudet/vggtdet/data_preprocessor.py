...
class VGGTDetDataPreprocessor(DetDataPreprocessor):
    ...
    def simple_process(self, data: dict, training: bool = False) -> dict:
        ...
        # batch_inputs['c2w'] = inputs['c2w']
        # batch_inputs['intrinsic'] = inputs['intrinsic']
            ...
            if is_seq_of(_batch_imgs, torch.Tensor):
                ...
                if img_dim == 3:
                    ...
                    batch_imgs = multiview_img_stack_batch(
                        batch_imgs, self.pad_size_divisor, self.pad_value) # stack a batch and pad to make sure size // pad_size_divisor. pad_value = 0
