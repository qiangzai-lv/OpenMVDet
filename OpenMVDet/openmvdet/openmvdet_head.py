...
from OpenMVDet.detr3_models.utils.votenet_pc_util import write_ply_rgb, write_bbox


@MODELS.register_module()
class OpenMVDetDetHead(BaseModule):
    ...
    def __init__(self,
        ...
        super(OpenMVDetDetHead, self).__init__(init_cfg)
