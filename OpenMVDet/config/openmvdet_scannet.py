...
custom_imports = dict(imports=['OpenMVDet.openmvdet'], allow_failed_imports=False)
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            ...
            # 'scannet_infos_train_pts_10scenes.pkl', #'scannet_infos_train_pts.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        # 'scannet_infos_train_pts_10scenes.pkl', #'scannet_infos_val_pts.pkl', #
